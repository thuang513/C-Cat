...
/**
 *  This is the main class used to test and view Sentence functions.
...
public class SentenceMain {
	...
	public static void usage() {
		System.out.println("SentenceMain <file of first sentence> <file of second sentence>");
	}
	...
	public static void main(String[] args) {
		...
		Sentence compareSentence = new CosineSimilaritySentence(secondSentenceString, basis);
		...
		System.out.println("COMPARE: " + secondSentenceString);
